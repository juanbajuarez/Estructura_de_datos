...
nombre, primer_apellido, segundo_apellido = "Juan", "Bautista", "Juárez"  # Se asignan valores
# distintos de tipo cadena a distintas variables con una sola sentencia de asignación.
print(f"Asignación múltiple de cadenas: {nombre} {primer_apellido} {segundo_apellido}.")

entero1, entero2 = 1, 2  # Se puede usar con enteros.
print(f"Asignación múltiple de enteros: {entero1} y {entero2}.")

decimal1, decimal2, decimal3, decimal4 = 3.14, 3.1416, 3.14159, 3.141592  # Se puede usar con flotantes.
print(f"Asignación múltiple de decimales: {decimal1}, {decimal2}, {decimal3} y {decimal4}.")

nombre, entero1, decimal4 = "Juan", 12, 3.1415926  # Es posible combinar tipos de datos.
...
entero6, entero5 = entero5, entero6  # Cambio de valores de tipo entero.
...
# Se pueden hacer cambios con distintos tipos de datos.
